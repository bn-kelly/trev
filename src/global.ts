 ...
 */
export const getValueFromStorage = async (field: string, storage:string = STORAGE_GLOBAL) => {
 ...
 * @param {string} storage 
 */
export const setValueToStorage = async (data: any, storage: string = STORAGE_GLOBAL) => {
    return new Promise((resolve, reject) => {
        if (storage === STORAGE_GLOBAL) {
            try {
